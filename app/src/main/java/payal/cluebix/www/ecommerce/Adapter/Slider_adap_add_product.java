...
public class Slider_adap_add_product extends PagerAdapter {

    private LayoutInflater layoutInflater;
    Activity activity;
    List<Bitmap> image_arraylist;

    public Slider_adap_add_product(Activity activity, List<Bitmap> image_arraylist) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
       ...
       // Log.e("dashboard_imageUrl", image_arraylist.get(position));
      /*  Picasso.with(activity.getApplicationContext())
                .load("sdcard/"+image_arraylist.get(position))
