...
public class Unit_Adapter extends RecyclerView.Adapter<Unit_Adapter.ProductViewHolder>{
    private Context mCtx;
    private ArrayList<unit_color_data> productList;
    Unit_Adapter.ClickListener clickListener;
    String url2= Base_url.UpdateUnit;


    public Unit_Adapter(Context mCtx, ArrayList<unit_color_data> productList) {
        this.mCtx = mCtx;
        this.productList = productList;
    }

    @Override
    public Unit_Adapter.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new Unit_Adapter.ProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final Unit_Adapter.ProductViewHolder holder, final int position) {
        ...
        holder.options.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View dialogView = inflater.inflate( R.layout.popup_add_unit_list,null);
                    ...
                    public void onClick(View v) {
                        ...
                        StringRequest stringRequest=new StringRequest(Request.Method.POST, url2+a.getId(), new Response.Listener<String>(){
                            ...
                            protected Map<String, String> getParams() throws AuthFailureError {
                                ...
                                parameters.put("unit_name",name1);
                                return parameters;
                            }
                        };
    ...
    public void setClickListener(Unit_Adapter.ClickListener clickListener){
